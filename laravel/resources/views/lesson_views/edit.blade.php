                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <form class="form-horizontal" role="form"
                                      action="{{ route('lesson_views.update', $lesson->id) }}" method="POST">
                                    ...
                                    <div class="form-group{{ $errors->has('dependency') ? ' has-error' : '' }}">
                                        <label for="dependency" class="col-md-4 control-label">This should be finished to
                                            continue</label>
                                        <div class="col-md-6 radio">
                                    ...
                                    <div class="form-group{{ $errors->has('dev_mode') ? ' has-error' : '' }}">
                                        <label for="dev_mode" class="col-md-4 control-label">Lesson in development</label>
                                        <div class="col-md-6 radio">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6 col-md-offset-4">
                                            <a class="btn btn-default"
                                               href="{{ route('lesson_views.create') }}">Back</a>
