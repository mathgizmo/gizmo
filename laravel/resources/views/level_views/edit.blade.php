            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <form class="form-horizontal" role="form" action="{{ route('level_views.update', $level->id) }}" method="POST">
                           ...
                           <div class="form-group{{ $errors->has('dev_mode') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6 radio">
                                    <label for="type" class="col-md-3"> <input {{ ($level->dev_mode == true) ? 'checked="checked"' : ''}} type="checkbox" name="dev_mode" value="1"></label>
