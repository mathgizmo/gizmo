			...
			<div class="panel panel-default">
				<div class="panel-heading">Question Details</div>
					...
					<div class="panel-body">
							...
							<div class="col-md-2">
							<div class="form-group">
								<label for="name">Mandatoriness</label>
							</div>
							</div>
							
							<div class="col-md-10">
									<p class="form-control-static"> {{$question->mandatoriness}}</p>
							</div>
						</div>
							<div class="row bg-success">
							<div class="col-md-2">
							...
							<div class="col-md-2">
							<div class="form-group">
								<label for="name">Mcq1</label>
							</div>
							</div>
							
							<div class="col-md-10">
									<p class="form-control-static"> {{$question->mcq1}}</p>
							</div>
						</div>
							...
							<div class="col-md-2">
							<div class="form-group">
								<label for="name">Mcq2</label>
							</div>
							</div>
							
							<div class="col-md-10">
									<p class="form-control-static"> {{$question->mcq2}}</p>
							</div>
						</div>
							...
							<div class="col-md-2">
							<div class="form-group">
								<label for="name">Mcq3</label>
							</div>
							</div>
							
							<div class="col-md-10">
									<p class="form-control-static"> {{$question->mcq3}}</p>
							</div>
						</div>
							...
							<div class="col-md-2">
							<div class="form-group">
								<label for="name">Mcq4</label>
							</div>
							</div>
							
							<div class="col-md-10">
									<p class="form-control-static"> {{$question->mcq4}}</p>
							</div>
						</div>
							...
							<div class="col-md-2">
							<div class="form-group">
								<label for="name">Mcq5</label>
							</div>
							</div>
							
							<div class="col-md-10">
									<p class="form-control-static"> {{$question->mcq5}}</p>
							</div>
						</div>
							...
							<div class="col-md-2">
							<div class="form-group">
								<label for="name">Mcq6</label>
							</div>
							</div>
							
							<div class="col-md-10">
									<p class="form-control-static"> {{$question->mcq6}}</p>
							</div>
						</div>
